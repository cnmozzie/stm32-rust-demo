...
fn main() -> ! {
    ...
    if let (Some(dp), Some(_)) = (
        ...
        iface
            .routes_mut()
            .add_default_ipv4_route(Ipv4Address::new(192, 168, 50, 1))
            .unwrap();

        iface.update_ip_addrs(|addrs| addrs.push(IpCidr::new(smoltcp::wire::IpAddress::v4(192, 168, 50, 87), 24)).unwrap());
